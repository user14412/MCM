...
@Service
public class GetlistExhibitLikeServiceImpl implements GetlistExhibitLikeService {
    @Autowired
    ...
    @Override
    public List<Exhibit> getlistExhibitLike(Integer userId) {
        // 取出当前用户点赞的所有藏品信息作为一个list返回给前端
